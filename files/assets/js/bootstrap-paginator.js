...
(function ($) {
    ...
    BootstrapPaginator.prototype = {
        ...
        getPages: function () {
            ...
            for (i = pageStart, counter = 0; counter < this.numberOfPages && i <= totalpages;="" i="i" +="" 1,="" counter="counter" 1)="" {="" fill="" the="" pages="" output.push(i);="" }="" if="" (this.currentpage=""> 1) {//add the first when the current page leaves the 1st page.
                output.first = 1;
            } else {
                output.first = null;
            }
